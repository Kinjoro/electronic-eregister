...
<div class="form-container">
	...
	<form class="form" action="insert_student.php" onsubmit="return validateForm()">
		<div class="input-group">
			<label for="registration_number">Registration</label>
			<input type="text" name="registration_number" id="registration_number" placeholder="">
		</div>
    <div class="input-group">
			<label for="school_email">School Email</label>
			<input type="text" name="school_email" id="school_email" placeholder="">
		</div>
		<div class="input-group">
  ...
  <input type="password" name="confirm_password" id="confirm_password" placeholder="">
		...
		<button class="sign" id="signup_button" >Sign up</button>
	</form>
...
fetch('insert_student.php', {
  ...
  body: `registration_number=${registrationNumberInput.value}&school_email=${schoolEmailInput.value}&password=${passwordInput.value}&confirm_password=${confirmPasswordInput.value}`,
})
